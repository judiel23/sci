...
require('../modelo/mod_connex.php');
		...
		$mysqlconn= $conexion->conectar();
					...
					$listar=$consulta-> obtenercompleto ($mysqlconn);
...
<table width="580px" border="1" align="left" id="listado">
      ...
      <tr>
              ...
              <th align="right" bgcolor="#eeece1"><div align="center" class="style2">Fecha Actualización</div></th>
       ...
       <tr>
             ...
             <td bgcolor="#f7f6f1"><div align="center" class="style5c"><?php echo $con_asun;?> </div>
             <td bgcolor="#fcfcfa"><div align="center" class="style5"><?php echo $con_nomusu;?> </div>
             <td bgcolor="#f7f6f1"><div align="center" class="style5"><?php echo $con_numov;?> </div>
