		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Content -->
                  ...
                  <form action="buscar.php" method="POST"><p>INGRESE EL NÚMERO DEL CASO QUE DESEA BUSCAR</p>
				<table width="500" border="1">
  <tr>
				    <td width="176">&nbsp;</td>
	<td width="810" align="center" scope="col"><div align="right">
	  <input name="gar_numcas" type="text" placeholder="123456789" required >
    </div></td>
	<td width="386" align="left" scope="col"><input name="Buscar" type="submit" value="Buscar"></td>
  </tr>
</table>
                  <?php require("../controlador/listar_completo.php");?>
