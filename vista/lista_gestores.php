		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Content -->
							...
							<!-- Post -->
								<article class="box post post-excerpt">
									...
									<div class="info">
										...
										<span class="date"><span class="month">Gestores<span>y</span></span> <!--<span class="day">14</span><span class="year">, 2014</span></span>-->
										<!--
                  ...
                  <div align="top">
							<?php require ("../controlador/con_listarEmpleado.php");?>
                    </div>
								</article>
