...
<html>
  ...
  <input name="Buscar" type="submit" value="Buscar">-->
  		...
  		<form action="buscar_conatel.php" method="POST"><p>INGRESE EL CASO QUE DESEA BUSCAR</p>
				<table width="500" border="1">
  <tr>
	<td width="176">&nbsp;</td>
	<td width="810" align="center" scope="col"><div align="right"><input name="con_numcas" type="text" placeholder="123456" required ></div></td>
	<td width="386" align="left" scope="col"><input name="Buscar" type="submit" value="Buscar"></td>
  </tr>
</table>
                  <?php require("../controlador/listar_conatel.php");?>
